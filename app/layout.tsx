...
export const metadata: Metadata = {
  ...
  metadataBase: new URL('https://daily-weather-two.vercel.app'),
  alternates: {
    canonical: '/',
  },
  openGraph: {
...
export default function RootLayout({
  ...
  const organizationSchema = {
    ...
    '@type': 'Organization',
    name: 'Daily Weather',
    url: 'https://daily-weather-two.vercel.app',
    logo: 'https://daily-weather-two.vercel.app/logo.png',
  ...
  const websiteSchema = {
    ...
    potentialAction: {
      ...
      target: {
        '@type': 'EntryPoint',
        urlTemplate: 'https://daily-weather-two.vercel.app/search?q={search_term_string}',
      },
